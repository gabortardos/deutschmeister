...
## Status: M0 ✅ · M0.1 ✅ · M1 ✅ · M1.1 ✅ · M1.2 ✅ · M2 ✅ · M2.1 ✅ · M2.2 ✅ · M2.3 ✅ · M3 ✅ · M4.1 ✅ · M4 ✅ — **v1.0.0 complete** 🎉 · **Phase 2: M4.2 ✅ (v1.0.1) · M5.1 ✅ (v1.1.0) · M5.2 ✅ (v1.1.1) · M5.3 ✅ (v1.1.2) · M6.1 ✅ (v1.2.0) · M6.2 ✅ (v1.2.1) · M6.3 ✅ (v1.2.2) · M7.1 ✅ (v1.3.0) · M7.2 ✅ (v2.0.0) · M8 ✅ (v2.1.0) · M8.1 ✅ (v2.1.1) · M8.2 ✅ (v2.2.0) · M8.3 ✅ (v2.3.0) · M9–M11 ⬜ (M9.5 onboarding planned)** — full plan: `docs/PHASE2_PLAN.md`
...
| 2026-09-21 | M8.3: tsc+vitest(218)+build+preview-smoke 200+secrets scan + LIVE relay curl | ✅ green — provider UX de-confusion: relabels ("GLM via z.ai — Coding Plan (recommended)" / "GLM via bigmodel.cn (mainland)"), model picker annotates free-vs-balance (explains owner's bigmodel.cn result: only glm-4.5-flash answers on a fresh free account), relay providers show a static "managed automatically" endpoint (no relay: sentinel to stare at, nothing to paste), anti-password-manager attrs (name/data-1p-ignore/data-lpignore) on base-URL + key inputs, per-provider manual titles (z.ai vs bigmodel.cn vs OpenAI vs DeepSeek); Paddle compliance pages: /#/about, /#/contact (gabor@deutschmeister.gaborscreation.space), /#/terms, /#/privacy, /#/refund (14-day policy) in src/features/legal/LegalPages.tsx + footer links on every page (hash routes, no 404 fallback needed); M9.5 Welcome & onboarding planned (owner vision: intro ? 2026-09-21 | M8.3: tsc+vitest(218)+build+preview-smoke 200+secrets scan + LIVE relay cext); live ai-proxy relay verified end-to-end via curl (OPTIONS allow-headers includes x-dm-byo-key; dummy-key POST returns z.ai's own 401 — relay deployed and forwarding), +2 tests (216→218), v2.3.0 |
